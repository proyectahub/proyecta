...
export function MiningOptionsModal({
  ...
  return createPortal(
    <div className="fixed inset-0 flex items-center justify-center p-4" style={{ zIndex: 2147483647 }}>
      ...
      <div className="relative max-h-[90vh] w-full max-w-5xl overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black/10">
        ...
        <div className="max-h-[calc(90vh-88px)] space-y-8 overflow-y-auto p-8">
