...
export function LoginExperience() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      await loginWithWallet(mainAddress)
      setStep('success')
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
        <div className="w-full max-w-lg space-y-8">
          ...
          <div className="bg-emerald-50 border-2 border-emerald-300 rounded-lg p-6 space-y-3">
            ...
            <ul className="space-y-2 text-sm text-emerald-800"><li>✅ PROYECTA nunca toca tu dinero</li><li>✅ Solo guardamos tu dirección pública</li><li>✅ Tu dirección recibe los XMR del proyecto</li><li>✅ El saldo acreditado se consulta en el pool, no en la dirección pública</li></ul>
          </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
        <div className="w-full max-w-lg space-y-6">
          <div className="text-center space-y-2"><h2 className="text-3xl font-bold text-slate-900">Conectar wallet</h2><p className="text-slate-600">Ingresa únicamente tu dirección pública Monero.</p></div>
