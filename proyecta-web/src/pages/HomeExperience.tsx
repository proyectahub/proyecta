      ...
      <section className="grid gap-6 xl:grid-cols-2">
        <div className="nova-card overflow-hidden p-6 md:p-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="space-y-2"><p className="nova-eyebrow text-emerald-700">Proyectos Financiados</p><h2 className="nova-title text-3xl font-extrabold text-slate-900">Investigación apoyada por la comunidad</h2><p className="max-w-2xl text-base leading-8 text-slate-600">Aquí aparecen primero los proyectos que han alcanzado o superado su meta de financiamiento. El orden se mueve por apoyo comunitario y rota cada semana entre los proyectos más respaldados para repartir mejor la visibilidad.</p></div>
