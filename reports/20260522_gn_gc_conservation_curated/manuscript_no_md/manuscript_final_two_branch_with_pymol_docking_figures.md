...
To avoid mixing the nucleoprotein and glycoprotein hypotheses, docking-pose visualization was separated by target. For each target, one PyMOL figure shows the global docked pose in the protein context and one zoom panel shows the predicted local pocket environment. Residue labels were intentionally limited to the closest pocket residues to avoid over-cluttering and to keep the figures suitable for publication.

### Figure 8. 5E04 nucleoprotein / paroxetine docking pose
![5E04 nucleoprotein / paroxetine docking pose](composite_figures/Figure_8_5E04_paroxetine_pymol_docking.png)

Figure 8. PyMOL visualization of the 5E04/paroxetine docking result. (A) Overall pose location in the 5E04 nucleoprotein structure. (B) Zoomed pocket view with selected nearby residue labels and inferred contact guides. This figure supports structural inspection of the nucleoprotein-branch hypothesis and does not establish binding affinity.

### Figure 9. 9P3Y Gn/Gc glycoprotein / granisetron docking pose
![9P3Y Gn/Gc glycoprotein / granisetron docking pose](composite_figures/Figure_9_9P3Y_granisetron_pymol_docking.png)

Figure 9. PyMOL visualization of the 9P3Y/granisetron docking result. (A) Overall pose location in the Gn/Gc glycoprotein-related structure. (B) Zoomed view of the exploratory glycan/NAG-associated pocket with selected nearby residue labels. This panel strengthens the glycoprotein branch of the manuscript while retaining the interpretation as a computational pocket hypothesis only.
