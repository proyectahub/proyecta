...
Run 20260513T065853Z_test_f75a92db | Mode: test | Status: partial


## Project Summary

- **Run ID**: 20260513T065853Z_test_f75a92db
- **Config hash**: f75a92dbc5b2585f4e9e7f19cc7f70ec9c4f8940c2338636980dfdb7fe9c3bf4
- **Timestamp**: 20260513T065853Z
- **Python**: 3.10.11
- **OS**: Windows
...
| --- | --- | --- | --- | --- | --- | --- |
| 9P3Y | prepared_no_pdbqt | I, J, K, L, M, N, O, P, A, B, C, D, E, F, G, H, Q, R, S, T, U, V, W, X | A | I:\MDATOS2.0\receptors\prepared\20260513T065853Z_test_f75a92db\9P3Y\9P3Y_prepared.pdb | NA | Detected 1524 missing residue annotations in the raw structure., Raw structure contains 1 hetero-residue entries befo... |
| 5E04 | prepared_no_pdbqt | A, B | A | I:\MDATOS2.0\receptors\prepared\20260513T065853Z_test_f75a92db\5E04\5E04_prepared.pdb | NA | Detected 22 missing residue annotations in the raw structure., Receptor PDBQT conversion was not completed. |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | ibuprofen | 0.555 | medium | NA | NA | NA |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | ibuprofen | 0.555 | medium | 0.500 | 0.500 | 0.820 | 0.000 |
| 2 | nicotinamide | 0.547 | low | 0.500 | 0.500 | 0.768 | 0.000 |
| 3 | caffeine | 0.528 | low | 0.500 | 0.500 | 0.673 | 0.000 |
...
| --- | --- | --- | --- |
| nicotinamide | 0.547 | below_top_rank_threshold | not_prioritized |
| caffeine | 0.528 | below_top_rank_threshold | not_prioritized |
...
- QSAR scoring failed: 'similarity'
